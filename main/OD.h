...
********************************************************************************
    ...
    File info:
        ...
        Project File: motor.xdd
        File Version: 24.04.1

        Created:      11/04/2024 18:25:46
    ...
    Device Info:
        ...
        Vendor ID:    2137
        Product Name: Motor Control Unit
        Product ID:   0004

        Description:  CANOpen dictionary for Hydros Motor
*******************************************************************************/
...
#define OD_ENTRY_H6400_vehicleSpeed &OD->list[19]
