...
typedef struct {
    ...
    OD_obj_var_t o_6400_vehicleSpeed;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6400_vehicleSpeed = {
        .dataOrig = &OD_RAM.x6400_vehicleSpeed,
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6400, 0x01, ODT_VAR, &ODObjs.o_6400_vehicleSpeed, NULL},
